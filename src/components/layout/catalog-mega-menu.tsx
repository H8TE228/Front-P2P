...
export function CatalogMegaMenu({ open, onClose }: CatalogMegaMenuProps) {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 top-16 z-[75]">
        ...
        <nav
          className={cn(
            "flex max-h-[min(220px,35vh)] w-full shrink-0 flex-col overflow-y-auto border-[#F3F4F6] bg-[#F8FAFC]/50 py-2 pr-px dark:border-[#1D293D] dark:bg-slate-900/40 md:max-h-none md:w-[min(340px,38%)] md:border-r md:border-b-0",
          ...
          {CATALOG_CATEGORIES.map((cat, index) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "flex w-full items-center gap-3 py-2.5 pl-5 pr-5 text-left text-sm font-medium leading-5 transition-colors",
                  isSelected
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <h3 className="text-sm font-semibold leading-5 text-[#0F172B] dark:text-[#F1F5F9]">
