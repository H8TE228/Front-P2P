                  ...
                  render={({ field, fieldState }) => (
                    <Field data-invalid={fieldState.invalid}>
                      ...
                      <FieldDescription className="text-xs leading-4 text-[#62748e] dark:text-[#90a1b9]">
                        Используйте понятное название без лишних слов. Это
                        поможет людям быстрее найти вашу вещь.
                      </FieldDescription>
                      {fieldState.invalid && (
                  ...
                  render={({ field, fieldState }) => (
                    <Field data-invalid={fieldState.invalid}>
                      ...
                      <textarea
                        ...
                        className="focus-visible:border-ring focus-visible:ring-ring/50 min-h-[122px] w-full resize-none rounded-[14px] border border-[#e2e8f0] bg-[#f8fafc] px-4 py-3 text-base text-[#0f172b] outline-none placeholder:text-[#90a1b9] focus-visible:ring-3 dark:border-white/10 dark:bg-[#020618] dark:text-white dark:placeholder:text-[#62748e]"
                      />
